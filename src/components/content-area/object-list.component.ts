...
@Component({
  ...
  template: `
    ...
    >
      <!-- Header -->
      <div
        class="px-4 py-3 bg-gray-50 dark:bg-gray-700 border-b border-gray-200 
                  dark:border-gray-600 rounded-t-lg"
      >
        <div
          class="grid grid-cols-12 gap-4 text-sm font-medium text-gray-700 dark:text-gray-300"
        >
        ...
        >
          <div class="grid grid-cols-12 gap-4 items-center">
            ...
            <div class="col-span-1">
              ...
              <img
                [src]="
                  item.previewUrl || 'https://via.placeholder.com/32?text=Img'
                "
            ...
            <div class="col-span-2">
              <div class="text-sm text-gray-600 dark:text-gray-400">
                @if (item.isFolder) { Folder } @else if (item.contentType) {
